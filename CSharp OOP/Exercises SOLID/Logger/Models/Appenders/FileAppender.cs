...
namespace Logger.Models.Appenders
{
    public class FileAppender : IAppender
    {
        ...
        {
            return
                $"Appender type: {this.GetType().Name}, Layout type: {this.Layout.GetType().Name}, Report level: {this.Level.ToString()}, Messages appended: {this.messagesAppended} File size: {this.File.Size}";
        }
    }
}
