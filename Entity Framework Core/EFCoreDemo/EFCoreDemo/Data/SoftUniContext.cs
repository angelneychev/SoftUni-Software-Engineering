...
namespace EFCoreDemo.Data
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<NewTableEmployees> NewTableEmployees { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=ANGEL_LAPTOP\\SQLEXPRESS;Database=SoftUni;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NewTableEmployees>(entity =>
            {
                entity.HasNoKey();
