...
namespace _05._Teamwork_projects
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var blokTeams = listOfTeams.Where(m => m.Members.Count == 0).OrderBy(n => n.Name).ToList();
            var peapleTeams = listOfTeams.Where(m => m.Members.Count > 0).OrderByDescending(m => m.Members.Count)
            ...
            foreach (Team team in blokTeams)
            {
                Console.WriteLine(team.Name);
            }
        }
