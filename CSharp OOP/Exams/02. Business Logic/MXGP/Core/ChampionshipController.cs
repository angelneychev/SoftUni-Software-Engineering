...
namespace MXGP.Core
{
    public class ChampionshipController : IChampionshipController
    {
        ...
        {
            var motocycle = this.motorcycleRepository.GetByName(model);
            if (motocycle !=null)
            {
            ...
            if (type == "Speed")
            {
                motocycle = new SpeedMotorcycle(model,horsePower);
            }
            else if(type == "Power")
            {
                motocycle = new PowerMotorcycle(model,horsePower);
            }
            this.motorcycleRepository.Add(motocycle);


            string result = $"{motocycle.GetType().Name} {model} is created.";
        ...
        public string AddRiderToRace(string raceName, string riderName)
        {
            ...
            string result = $"Rider {riderName} added in {raceName} race.";
        ...
        public string AddMotorcycleToRider(string riderName, string motorcycleModel)
        {
            ...
            string result = $"Rider {riderName} received motorcycle {motorcycle}.";
